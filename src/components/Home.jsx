...
{/* <Marquee pauseOnHover={true} className=''> */}
 
 {
   brands.map(brand=> <>
    ...
    <div key={brand._id} className="card max-sm:w-[20rem] w-[24rem] my-10 mr-10 bg-base-100 shadow-xl">
  <figure className="px-10 pt-10">
    <img className='bg-cover rounded-xl w-[10rem]' src={brand?.image} alt="Shoes"  />
  </figure>
  <div className="card-body items-center text-center">
    <h2 className="card-title font-serif capitalize">{brand?.brand}</h2>
